...
export default function BusolaDeciziilorExperienceEditionPage() {
  ...
  return (
    <div className="bg-white">
      ...
      <section className="relative min-h-[50vh] flex items-center overflow-hidden" style={{ backgroundColor: "#F5F0E8" }}>
        ...
        <div className="relative z-10 max-w-5xl mx-auto px-6 sm:px-8 lg:px-12 py-10 w-full">
          <div className="flex items-center gap-3 mb-5 flex-wrap">
            ...
            <Link href="/programe/busola-deciziilor" className="text-xs font-semibold uppercase tracking-[0.2em] hover:opacity-70 transition-opacity" style={{ color: "#A0715A" }}>
              Busola Deciziilor
            </Link>
            <span className="text-xs" style={{ color: "rgba(0,0,0,0.25)" }}>→</span>
            <span className="text-xs font-semibold uppercase tracking-[0.2em]" style={{ color: "rgba(0,0,0,0.4)" }}>Experience Edition</span>
          </div>
          ...
          <h1 className="text-2xl sm:text-3xl lg:text-5xl font-bold mb-4 leading-tight" style={{ fontFamily: "Playfair Display, serif", color: "var(--charcoal)" }}>
            BUSOLA DECIZIILOR<br /><span className="italic" style={{ color: "#A0715A" }}>Experience Edition</span>
          </h1>
            ...
            {editions.map((ed) => {
              ...
              return (
                <div key={ed.id} className="rounded-2xl p-5 border" style={{ borderColor: "rgba(0,0,0,0.08)", boxShadow: "0 2px 16px rgba(0,0,0,0.04)" }}>
                  ...
                  >
                    {remaining === 0 ? "Grupă completă" : "Rezervă locul"}
                  </button>
                </div>
              );
            })}
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 items-start">
            <div>
              ...
              <p className="text-base leading-relaxed mb-6" style={{ color: "var(--charcoal-soft)" }}>
                BUSOLA DECIZIILOR este pentru oamenii care îşi doresc să îşi ofere timp pentru reflecție, dezvoltare şi clarificarea următorilor paşi.
              </p>
      ...
      {/* MĂRTURII — placeholder până la colectarea feedback-ului */}
      <section className="py-10 bg-white">
        <div className="max-w-3xl mx-auto px-6 sm:px-8 lg:px-12 text-center">
          <p className="text-xs font-semibold uppercase tracking-[0.25em] mb-4" style={{ color: "#A0715A" }}>Comunitate</p>
          <h2 className="text-2xl sm:text-3xl font-semibold mb-4" style={{ fontFamily: "Playfair Display, serif", color: "var(--charcoal)" }}>
          ...
          <div className="rounded-2xl p-6" style={{ backgroundColor: "#F5F0E8" }}>
            <p className="text-sm leading-relaxed" style={{ color: "var(--charcoal-soft)" }}>
              Mărturiile primei ediții vor fi publicate aici. Dacă ai participat deja, ne poți împărtăși experiența ta — contribuția ta ajută și alți profesioniști să iau decizia potrivită.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-5xl mx-auto px-6 sm:px-8 lg:px-12">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 items-start">
            ...
            <div className="rounded-2xl bg-white p-6 text-center" style={{ boxShadow: "0 4px 32px rgba(0,0,0,0.07)", border: "1px solid rgba(0,0,0,0.06)" }}>
              ...
              <p className="text-3xl font-bold mb-3" style={{ fontFamily: "Playfair Display, serif", color: "var(--charcoal)" }}>În curs de confirmare</p>
              <p className="text-sm mb-4" style={{ color: "var(--charcoal-soft)" }}>Prețul și condițiile de plată vor fi comunicate imediat ce detaliile logistice sunt finalizate.</p>
        ...
        <div className="max-w-5xl mx-auto px-6 sm:px-8 lg:px-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            {[
              {
                day: "Ziua 1",
                title: "Cadrare și conectare",
                items: ["Primire și acomodare", "Stabilirea intenției", "Activități de grup și primul dialog", "Seară de conectare"],
              },
              {
                day: "Ziua 2",
                title: "Reflecție și perspective noi",
                items: ["Timp în natură", "Workshop-uri experiențiale", "Reflecție individuală și în perechi", "Conversații cu sens"],
              },
              {
                day: "Ziua 3",
                title: "Integrare și direcție",
                items: ["Sinteză personală", "Clarificarea următorilor pași", "Plan de acțiune", "Închiderea programului"],
              },
            ].map((d) => (
              <div key={d.day} className="rounded-2xl p-5 bg-white" style={{ boxShadow: "0 2px 16px rgba(0,0,0,0.05)" }}>
                <p className="text-xs font-semibold uppercase tracking-[0.25em] mb-2" style={{ color: "#A0715A" }}>{d.day}</p>
                <h3 className="text-lg font-semibold mb-4" style={{ fontFamily: "Playfair Display, serif", color: "var(--charcoal)" }}>{d.title}</h3>
                <ul className="space-y-3">
                  {d.items.map((item) => (
                    <li key={item} className="flex items-start gap-2 text-sm" style={{ color: "var(--charcoal-soft)" }}>
                      <span className="flex-shrink-0 w-1.5 h-1.5 rounded-full mt-1.5" style={{ backgroundColor: "#A0715A" }} />
                      {item}
                    </li>
                  ))}
                </ul>
        ...
        <div className="max-w-5xl mx-auto px-6 sm:px-8 lg:px-12">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
            <div className="rounded-2xl p-5 bg-white" style={{ boxShadow: "0 2px 16px rgba(0,0,0,0.06)" }}>
              ...
              <p className="text-sm leading-relaxed" style={{ color: "var(--charcoal-soft)" }}>Document care atestă participarea la programul BUSOLA DECIZIILOR şi prezența la activitățile desfăşurate pe parcursul experienței.</p>
            </div>
            <div className="rounded-2xl p-5 bg-white" style={{ boxShadow: "0 2px 16px rgba(0,0,0,0.06)" }}>
              <div className="text-3xl mb-4">📄</div>
      ...
      <section className="py-10 bg-white">
        <div className="max-w-5xl mx-auto px-6 sm:px-8 lg:px-12">
          <div className="text-center mb-6">
            ...
            <p className="text-base mt-6 max-w-2xl mx-auto leading-relaxed" style={{ color: "var(--charcoal-soft)" }}>
              La finalul programului BUSOLA DECIZIILOR, fiecare participant primeşte:
            </p>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
            <div className="rounded-2xl p-6 border" style={{ borderColor: "rgba(160,113,90,0.25)", backgroundColor: "#A0715A08" }}>
              ...
              <p className="text-sm leading-relaxed" style={{ color: "var(--charcoal-soft)" }}>
                Document care atestă participarea la programul BUSOLA DECIZIILOR şi prezența la activitățile desfăşurate pe parcursul experienței.
              </p>
            </div>
      ...
      <section className="py-12 bg-white">
        <div className="max-w-2xl mx-auto px-6 sm:px-8 text-center">
          ...
          <h2 className="text-2xl sm:text-3xl font-semibold mb-6 leading-tight" style={{ fontFamily: "Playfair Display, serif", color: "var(--charcoal)" }}>
            Interesat de{" "}
            <span className="italic" style={{ color: "#A0715A" }}>Experience Edition?</span>
          </h2>
          <p className="text-base leading-relaxed mb-6" style={{ color: "var(--charcoal-soft)" }}>
      ...
      {/* STICKY CTA */}
      {showSticky && (
        <div className="fixed bottom-0 left-0 right-0 z-40 bg-white border-t px-4 py-3 sm:py-4 shadow-[0_-4px_20px_rgba(0,0,0,0.08)]" style={{ borderColor: "rgba(0,0,0,0.06)" }}>
          <div className="max-w-5xl mx-auto flex flex-col sm:flex-row items-center justify-between gap-3">
            ...
            <button
              ...
              className="w-full sm:w-auto px-6 py-3 rounded-xl font-semibold text-white text-sm transition-all hover:opacity-90 whitespace-nowrap"
              style={{ backgroundColor: "#A0715A" }}
            >
              Rezervă locul
            </button>
          ...
          <div className="bg-white rounded-t-2xl sm:rounded-2xl w-full sm:max-w-lg max-h-[92vh] overflow-y-auto" style={{ boxShadow: "0 20px 60px rgba(0,0,0,0.2)", overscrollBehavior: "contain" }}>
            {submitted ? (
              <div className="p-6 text-center">
                ...
                <p className="text-base leading-relaxed mb-4" style={{ color: "var(--charcoal-soft)" }}>În această perioadă centralizăm persoanele interesate de programul Busola Deciziilor.</p>
              ...
              <div className="p-6">
                <div className="flex items-center justify-between mb-6">
                  <h3 className="text-xl font-semibold" style={{ fontFamily: "Playfair Display, serif", color: "var(--charcoal)" }}>Manifestare de interes — Busola Deciziilor Experience Edition</h3>
                ...
                <div className="rounded-xl p-4 mb-2" style={{ backgroundColor: "#A0715A12", border: "1px solid rgba(160,113,90,0.25)" }}>
                    <p className="text-sm leading-relaxed" style={{ color: "var(--charcoal-soft)" }}>Înscrierile oficiale pentru <strong style={{ color: "var(--charcoal)" }}>BUSOLA DECIZIILOR</strong> se vor deschide după confirmarea detaliilor logistice și a calendarului final.</p>
