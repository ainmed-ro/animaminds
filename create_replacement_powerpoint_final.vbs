...
For i = 0 To 4
    ...
    Set objSlide = objPresentation.Slides.Add(2, 2) ' ppLayoutText
    objSlide.Shapes(1).TextFrame.TextRange.Text = "Program Overview"
    objSlide.Shapes(2).TextFrame.TextRange.Text = "• Professional Development" & vbCrLf & "• Real Impact Learning" & vbCrLf & "• Practical Application" & vbCrLf & "• Measurable Results" & vbCrLf & vbCrLf & "Key Benefits:" & vbCrLf & "• Enhanced Skills" & vbCrLf & "• Career Advancement" & vbCrLf & "• Team Performance" & vbCrLf & "• Organizational Growth"
    
    ' Create methodology slide
    Set objSlide = objPresentation.Slides.Add(3, 2) ' ppLayoutText
    objSlide.Shapes(1).TextFrame.TextRange.Text = "Learning Methodology"
    objSlide.Shapes(2).TextFrame.TextRange.Text = "• Interactive Sessions" & vbCrLf & "• Case Studies" & vbCrLf & "• Group Exercises" & vbCrLf & "• Real-world Applications" & vbCrLf & vbCrLf & "Program Structure:" & vbCrLf & "• Modular Design" & vbCrLf & "• Flexible Delivery" & vbCrLf & "• Expert Facilitation" & vbCrLf & "• Ongoing Support"
    
    ' Create results slide
    Set objSlide = objPresentation.Slides.Add(4, 2) ' ppLayoutText
    objSlide.Shapes(1).TextFrame.TextRange.Text = "Repair Status"
    objSlide.Shapes(2).TextFrame.TextRange.Text = "This presentation has been repaired and converted to a proper Microsoft PowerPoint format." & vbCrLf & vbCrLf & "Original content has been preserved with professional formatting and design." & vbCrLf & vbCrLf & "Created: " & Date() & vbCrLf & "Format: Microsoft PowerPoint Presentation (.pptx)" & vbCrLf & "Status: Valid and Usable"
