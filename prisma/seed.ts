  ...
  const programmes = [
    {
      ...
      onsiteIncludedServices: [
        'livrarea integrală a programului de formare',
        'certificat de participare pentru fiecare participant',
        'fișa competențelor dobândite pentru fiecare participant',
        'acces la resurse și materiale digitale',
        'activități practice și exerciții aplicate',
        'studii de caz și exemple relevante',
        'instrumente și modele de lucru utilizabile imediat',
        'sesiuni de reflecție și transfer în practică',
        'oportunități de schimb de experiență și bune practici între participanți',
